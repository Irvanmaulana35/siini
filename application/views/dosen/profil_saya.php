...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        } ?><?= form_open_multipart('dosen/profil_saya', 'role="form"') ?><div class='row'>
            <div class='col-md-3'>
                ...
                <div class='box box-primary'>
                    ...
                    <div class='box-body'>
                        <div class='row'>
                            <div class="col-md-12">
                                <div class="box-body">
                                    <div class="form-group"><label>NID</label><input type="text" class="form-control" name="nid" value="<?= $ps['nid'] ?>" maxlength="20" placeholder="NID" readonly></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="box-body">
                                    <div class="form-group"><label>Nama Dosen</label><input type="text" class="form-control" name="nama_dosen" value="<?= $ps['nama_dosen'] ?>" maxlength="30" placeholder="Nama Dosen"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <hr>
                    ...
                    <div class='box-footer'><button type='submit' name='submit' class='btn btn-success btn-flat'>Simpan</button><a href='<?= base_URL() ?>dosen/dashboard' type='button' class='btn btn-warning btn-flat pull-right'>Batal</a></div>
                </div>
            </div>
            <?= form_close() ?>
    </section>
