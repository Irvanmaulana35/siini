 <div class="content-wrapper">
     <section class="content-header">
         <h1>Tambah Dosen<small>Master Data</small></h1>
         <ol class="breadcrumb">
             ...
             <div class="col-md-12">
                 <div class="box box-primary">
                     ...
                     <div class="row">
                         <div class="col-md-6">
                             <div class="box-body">
                                 <div class="form-group"><label>NID</label><input type="number" class="form-control" name="nid" maxlength="20" placeholder="NID" required autofocus></div>
                             </div>
                         </div>
                         <div class="col-md-6">
                             <div class="box-body">
                         ...
                         <div class="col-md-12">
                             <div class="box-body">
                                 <div class="form-group"><label>Nama Dosen</label><input type="text" class="form-control" name="nama_dosen" maxlength="30" placeholder="Nama Dosen" required autofocus></div>
                             </div>
                         </div>
                         <div class="col-md-12">
                             <div class="box-body">
                     ...
                     <div class="box-footer"><button type="submit" name="submit" class="btn btn-success btn-flat">Simpan</button><a href="<?= base_URL() ?>admin/dosen" class="btn btn-warning btn-flat pull-right">Batal</a></div>
                     <?= form_close() ?>
                 </div>
             </div>
         </div>
